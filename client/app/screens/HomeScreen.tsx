  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        thumbnailPlaceholder: { width: 48, height: 48, borderRadius: radii.sm, backgroundColor: colors.accentSoft },
        ...
        fabText: { fontFamily: theme.fonts.sansBold, fontSize: 16, color: colors.accentInk },
