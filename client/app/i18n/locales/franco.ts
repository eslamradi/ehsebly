...
export const franco: Translations = {
  ...
  account: {
    title: '7esaby',
    nameTitle: 'Esmak eh?',
    nameSub: '3ashan elli ma3ak fel group yeshoufo esmak mesh emailak.',
    namePlaceholder: 'El esm',
    a11yName: 'Esmak',
    saving: 'Betehfaz…',
    language: 'El logha',
    help: 'Mosa3da w tawasol',
    signOut: 'Tasgeel el khoroug',
    signedOutName: 'Mesh mosaggel',
    signedOutSub: 'El 7esab el sari3 mesh me7tag tasgeel.',
  },
  home: {
